  ...
  KeyboardPanel {
    ...
    PanelKeyCatcher { id: keys; anchors.fill: parent; onCloseRequested: root.close(); onTabRequested: function(direction) { root.switchPanel(direction) }
      Column { id: content; anchors.fill: parent; spacing: Style.space(10)
        ...
        Row { width: parent.width - Style.space(32); x: Style.space(16); spacing: Style.space(20)
          Text { text: "25 MIN"; textFormat: Text.PlainText; width: Style.space(70); elide: Text.ElideRight; color: root.bar ? root.bar.foreground : Color.foreground; font.family: root.bar ? root.bar.fontFamily : Style.font.family; font.pixelSize: Style.font.body; MouseArea { anchors.fill: parent; cursorShape: Qt.PointingHandCursor; onClicked: root.run(["--start", "1500"]) } }
          Text { text: "50 MIN"; textFormat: Text.PlainText; width: Style.space(70); elide: Text.ElideRight; color: root.bar ? root.bar.foreground : Color.foreground; font.family: root.bar ? root.bar.fontFamily : Style.font.family; font.pixelSize: Style.font.body; MouseArea { anchors.fill: parent; cursorShape: Qt.PointingHandCursor; onClicked: root.run(["--start", "3000"]) } }
          Text { text: "END"; textFormat: Text.PlainText; width: Style.space(45); elide: Text.ElideRight; color: root.bar ? root.bar.foreground : Color.foreground; font.family: root.bar ? root.bar.fontFamily : Style.font.family; font.pixelSize: Style.font.body; MouseArea { anchors.fill: parent; cursorShape: Qt.PointingHandCursor; onClicked: root.run(["--end"]) } }
        }
